...
func (x *SummaryDataPoint) Reset() {
	*x = SummaryDataPoint{}
	mi := &file_metrics_v1_metrics_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SummaryDataPoint) Descriptor() ([]byte, []int) {
	return file_metrics_v1_metrics_proto_rawDescGZIP(), []int{12}
}
...
func (x *Exemplar) Reset() {
	*x = Exemplar{}
	mi := &file_metrics_v1_metrics_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Exemplar) Descriptor() ([]byte, []int) {
	return file_metrics_v1_metrics_proto_rawDescGZIP(), []int{13}
}
...
func (x *ExponentialHistogramDataPoint_Buckets) Reset() {
	*x = ExponentialHistogramDataPoint_Buckets{}
	mi := &file_metrics_v1_metrics_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExponentialHistogramDataPoint_Buckets) Descriptor() ([]byte, []int) {
	return file_metrics_v1_metrics_proto_rawDescGZIP(), []int{11, 0}
}
...
func (x *SummaryDataPoint_ValueAtQuantile) Reset() {
	*x = SummaryDataPoint_ValueAtQuantile{}
	mi := &file_metrics_v1_metrics_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SummaryDataPoint_ValueAtQuantile) Descriptor() ([]byte, []int) {
	return file_metrics_v1_metrics_proto_rawDescGZIP(), []int{12, 0}
}
...
const file_metrics_v1_metrics_proto_rawDesc = "" +
	"\n" +
	"\x18metrics/v1/metrics.proto\x12\x1eopentelemetry.proto.metrics.v1\x1a\x16common/v1/common.proto\x1a\x1aresource/v1/resource.proto\"i\n" +
	"\vMetricsData\x12Z\n" +
	...
	"'DATA_POINT_FLAGS_NO_RECORDED_VALUE_MASK\x10\x01B7Z5github.com/canonical/pebble/internals/otlp/metrics/v1b\x06proto3"
...
func file_metrics_v1_metrics_proto_init() {
	...
	file_metrics_v1_metrics_proto_msgTypes[3].OneofWrappers = []any{
		(*Metric_Gauge)(nil),
		(*Metric_Sum)(nil),
	...
	file_metrics_v1_metrics_proto_msgTypes[9].OneofWrappers = []any{
		(*NumberDataPoint_AsDouble)(nil),
		(*NumberDataPoint_AsInt)(nil),
	}
	file_metrics_v1_metrics_proto_msgTypes[10].OneofWrappers = []any{}
	file_metrics_v1_metrics_proto_msgTypes[11].OneofWrappers = []any{}
	file_metrics_v1_metrics_proto_msgTypes[13].OneofWrappers = []any{
