...
// FIPS version: cert auth not supported, but basic auth can be configured (login blocked).
...
// FIPS version: allows basic identity storage (password hashes), blocks cert auth.
