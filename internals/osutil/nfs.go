...
// FakeIsHomeUsingRemoteFS mocks the real implementation of osutil.IsHomeUsingRemoteFS.
// This is exported so that other packages that indirectly interact with this
// functionality can mock IsHomeUsingRemoteFS.
func FakeIsHomeUsingRemoteFS(new func() (bool, error)) (restore func()) {
...
func FakeSnapDirsUnderNFSMounts(new func() (bool, error)) (restore func()) {
