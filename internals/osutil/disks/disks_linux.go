...
// FakeMountPointDisksToPartitionMapping, but we can't just assign
...
func FakeUdevPropertiesForDevice(new func(string, string) (map[string]string, error)) (restore func()) {
...
// FakeDevicePathToDiskMapping (which is yet to be added).
