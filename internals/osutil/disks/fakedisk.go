...
var _ = Disk(&FakeDiskMapping{})

// FakeDiskMapping is an implementation of Disk for mocking purposes, it is
...
func (d *FakeDiskMapping) FindMatchingPartitionWithPartUUID(uuid string) (Partition, error) {
...
func (d *FakeDiskMapping) FindMatchingPartitionWithFsLabel(label string) (Partition, error) {
	// TODO: this should just iterate over the static list when that is a thing
	osutil.MustBeTestBinary("mock disks only to be used in tests")
...
// for the specified filesystem label if it exists. Part of the Disk interface.
func (d *FakeDiskMapping) FindMatchingPartitionWithPartLabel(label string) (Partition, error) {
	osutil.MustBeTestBinary("mock disks only to be used in tests")
...
func (d *FakeDiskMapping) FindMatchingPartitionUUIDWithFsLabel(label string) (string, error) {
...
func (d *FakeDiskMapping) FindMatchingPartitionUUIDWithPartLabel(label string) (string, error) {
...
func (d *FakeDiskMapping) MountPointIsFromDisk(mountpoint string, opts *Options) (bool, error) {
	osutil.MustBeTestBinary("mock disks only to be used in tests")
...
// interface.
func (d *FakeDiskMapping) Dev() string {
	return d.DevNum
}

func (d *FakeDiskMapping) KernelDeviceNode() string {
	return d.DevNode
}

func (d *FakeDiskMapping) KernelDevicePath() string {
	return d.DevPath
}

func (d *FakeDiskMapping) DiskID() string {
	return d.ID
}

func (d *FakeDiskMapping) Model() string {
	return d.IDModel
}

func (d *FakeDiskMapping) Schema() string {
	return d.DiskSchema
}

func (d *FakeDiskMapping) SectorSize() (uint64, error) {
	return d.SectorSizeBytes, nil
}

func (d *FakeDiskMapping) UsableSectorsEnd() (uint64, error) {
	return d.DiskUsableSectorEnd, nil
}

func (d *FakeDiskMapping) SizeInBytes() (uint64, error) {
...
// FakeMountPointDisksToPartitionMapping.
type Mountpoint struct {
	Mountpoint        string
	IsDecryptedDevice bool
}

func checkMockDiskMappingsForDuplicates(mockedDisks map[string]*FakeDiskMapping) {
...
// FakePartitionDeviceNodeToDiskMapping will mock DiskFromPartitionDeviceNode
// such that the provided map of device names to mock disks is used instead of
// the actual implementation using udev.
func FakePartitionDeviceNodeToDiskMapping(mockedDisks map[string]*FakeDiskMapping) (restore func()) {
	osutil.MustBeTestBinary("mock disks only to be used in tests")
...
// FakeDeviceNameToDiskMapping will mock DiskFromDeviceName such that the
// provided map of device names to mock disks is used instead of the actual
// implementation using udev.
func FakeDeviceNameToDiskMapping(mockedDisks map[string]*FakeDiskMapping) (restore func()) {
	osutil.MustBeTestBinary("mock disks only to be used in tests")
	...
	// for FakeMountPointDisksToPartitionMapping
...
// FakeDevicePathToDiskMapping will mock DiskFromDevicePath such that the
// provided map of device names to mock disks is used instead of the actual
// implementation using udev.
func FakeDevicePathToDiskMapping(mockedDisks map[string]*FakeDiskMapping) (restore func()) {
	osutil.MustBeTestBinary("mock disks only to be used in tests")
...
// FakeMountPointDisksToPartitionMapping will mock DiskFromMountPoint such that
...
func FakeMountPointDisksToPartitionMapping(mockedMountPoints map[Mountpoint]*FakeDiskMapping) (restore func()) {
	osutil.MustBeTestBinary("mock disks only to be used in tests")

	// verify that all unique FakeDiskMapping's have unique DevNum's and that
	...
	alreadySeen := make(map[string]*FakeDiskMapping, len(mockedMountPoints))
