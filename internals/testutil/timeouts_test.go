...
func fakeEnvVar(envVar, value string) (restore func()) {
...
func (ts *TimeoutTestSuite) TestHostScaledTimeout(c *C) {
	restore := fakeEnvVar("GO_TEST_RACE", "")
	defer restore()

	restore = testutil.FakeRuntimeARCH("default")
	defer restore()
	...
	testcases := []testcase{
		{
			name:     "default ",
			setup:    func() func() { return testutil.FakeRuntimeARCH("some-fast-arch") },
			expected: origDuration,
		},
		{
			name:     "riscv64 arch",
			setup:    func() func() { return testutil.FakeRuntimeARCH("riscv64") },
			expected: 6 * origDuration,
		},
		{

			name:     "go test -race",
			setup:    func() func() { return fakeEnvVar("GO_TEST_RACE", "1") },
		...
		},
		{
			...
			setup: func() func() {
				archRestore := testutil.FakeRuntimeARCH("riscv64")
				envVarRestore := fakeEnvVar("GO_TEST_RACE", "1")
				return func() {
					archRestore()
					envVarRestore()
				}
