...
```{terminal}
pebble add-identities --from idents-add.yaml
...
```{terminal}
pebble remove-identities --from idents-remove.yaml
...
```{terminal}
pebble update-identities --from idents-update.yaml
...
```{terminal}
pebble update-identities --from idents-replace.yaml --replace
...
```{terminal}
pebble run --identities idents-add.yaml 
